...
% Graph of function with a hole, but limit exists
...
% Left-sided limit evaluations

Graphically, then, it looks like as $x\to a^-$, $f(x) \to L$.

\textbf{Right-Sided Limit}

% Right-sided limit evaluations
...
% Graph with vertical bar highlighting behavior.

% Graph with thinner vertical bar.
